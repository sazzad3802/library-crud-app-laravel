...
@section('content')
    ...
    <form action="{{ route('books.update',$book->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Publisher Company:</strong>
                    <input type="text" name="publisher" value="{{ $book->publisher }}" class="form-control" placeholder="Publisher Company">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" step="0.1" min="0" max="5" name="rating" value="{{ $book->rating }}" class="form-control" placeholder="Rating">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Published At:</strong>
                    <input type="date" name="year" value="{{ $book->year ? $book->year->format('Y-m-d') : '' }}" class="form-control">
                </div>
            </div>
